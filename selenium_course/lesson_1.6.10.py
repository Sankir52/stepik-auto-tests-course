...
try:
    ...
    #input4 = browser.find_element_by_xpath("//input[@placeholder='Input your phone:']")  # Phone:
    #input4.send_keys("Russia")
    #input5 = browser.find_element_by_xpath("//input[@placeholder='Input your address:']")  # Address:
